...
def main():
    ...
    color_change = {'r':'gold', 'g':'g', 'b':'r', 'black':'k'}
    ...
    df.plot(ax=f.gca(), kind='scatter', x='Median household income', y='Tip Perc', c='White', edgecolor=colors, s=df['Public Transportation Rate']*300)
